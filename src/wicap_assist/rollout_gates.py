...
def evaluate_rollout_gates(
    ...
    *,
    ...
    min_shadow_agreement_rate: float = 0.82,
    min_shadow_success_rate: float = 0.72,
    min_reward_avg: float = 0.05,
    max_autonomous_escalation_rate: float = 0.08,
    min_autonomous_runs: int = 5,
    max_rollback_failures: int = 1,
