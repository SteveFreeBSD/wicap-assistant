...
- Parity+ seed pass implemented: control/anomaly/telemetry v2+ contracts, sandbox policy trace, failover persistence, mission graph, deterministic replay/chaos certification harnesses, and autopilot supervisor runtime.
